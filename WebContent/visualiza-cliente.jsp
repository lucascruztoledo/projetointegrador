...
<form method="post" action ="VisualizarCliente">
 ...
 <input name="endereco" value="${cliente.endereco}" type="text" class="form-control" /> 
 </div>
 
 <div class="form-group">
 <label>Telefone:</label>
 <input name="telefone" value="${cliente.telefone}" type="text" class="form-control" /> 
 </div>
 ...
 <div class="form-group">
 <label>Estado:</label>
 <input name="estado" value="${cliente.estado}" type="text" class="form-control"/> 
 </div>
